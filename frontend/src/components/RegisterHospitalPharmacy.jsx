    ...
    try {
      ...
      if (networkData) {
        ...
        if (currentAccount !== owner) {
          console.error('You are not authorized to register hospitals/pharmacies.');
          this.setState({ errorMessage: 'You are not authorized to register hospitals/pharmacies.' });
        }
      } else {
  ...
  render() {
    return (
      <div className="register-container">
        <h2>Register Hospital/Pharmacy</h2>
...
export default RegisterHospitalPharmacy;