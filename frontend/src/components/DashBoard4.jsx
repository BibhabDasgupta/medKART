...
import HospitalPharmacyDetailsForm from './HospitalPharmacyDetails';
...
const DashBoard4 = () => {
  ...
  return (
    <div className="dashboard-container">
      <h2>Hospitals/Pharmacies Dashboard</h2>
      {status && formSubmitted ? (
        ...
        <>
          {!status && formSubmitted ? (
            ...
            <HospitalPharmacyDetailsForm onFormSubmit={handleFormSubmit} onLogout={handleLogout} />
          )}
        </>
      )}
    </div>
